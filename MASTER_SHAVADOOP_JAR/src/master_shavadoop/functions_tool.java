...
//		Define the size of the new aggregation dictionary with the number of workers available
...
//	Function for cleaning file : delete special characters
	public static String word_cleaner_regex(String dirty_words){
		String regex_pattern = "[aA-zZ0-9éèàùç]+";
